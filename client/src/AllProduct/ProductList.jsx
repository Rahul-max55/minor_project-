...
const ProductList = ({ id, price, category, description, filename, image, name, columnRow }) => {


  return (
    <>
      <NavLink to={`/singleproduct/${id}`} className={columnRow === "false" ? " " : "Anchor_Row"}>
        ...
        {columnRow === "false" ?
          ...
          <div className="prod_card Row">
            ...
            <div className="main_img_bottum_row">
              ...
              <button type='button' className='Add_cart_btn Row_btn' >Read More</button>
            </div>
          </div>
        }
      </NavLink>
